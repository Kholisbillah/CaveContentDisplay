...
namespace CaveContentDisplay
{
    public interface IGenericModConfigMenuApi
    {
        ...
        void AddKeybind(StardewModdingAPI.IManifest mod, Func<StardewModdingAPI.SButton> getValue, Action<StardewModdingAPI.SButton> setValue, Func<string> name, Func<string>? tooltip = null, string? fieldId = null);
